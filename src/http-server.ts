...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across DVI (Datu valsts inspekcija) decisions and sanctions.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'sīkdatnes', 'darbinieku uzraudzība')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Search DVI guidance documents on GDPR implementation in Latvia.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific DVI guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Latvian and English names.",
      ...
      switch (name) {
        ...
        case "lv_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "DVI (Datu valsts inspekcija) MCP server. Provides access to Latvian data protection authority decisions and guidance.",
